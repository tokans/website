...
/**
 * Public directory of apps listed for Tokans support (/apps). Any app built on
 * sharedCoreLib is eligible. Authenticated owners can register an app and
 * initiate the acceptance workflow (P0: marks it 'requested'; review→listed later).
 */
